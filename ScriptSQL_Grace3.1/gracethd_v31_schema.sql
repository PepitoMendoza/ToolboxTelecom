...
CREATE TABLE gracethd3_1_raw.t_site (
    ...
    st_user              VARCHAR(20),
    CONSTRAINT pk_t_site PRIMARY KEY (st_code, st_nd_code),
...
CREATE TABLE gracethd3_1_raw.t_ptech (
    ...
    pt_user              VARCHAR(20),
    CONSTRAINT pk_t_ptech PRIMARY KEY (pt_code, pt_codeext, pt_nd_code)
);
...
CREATE TABLE gracethd3_1_raw.t_ebp (
    ...
    bp_user              VARCHAR(20),
    CONSTRAINT pk_t_ebp PRIMARY KEY (bp_code, bp_codeext)
);
...
CREATE TABLE gracethd3_1_raw.t_cableline (
    ...
    CONSTRAINT pk_t_cableline PRIMARY KEY (cl_cb_code, cl_code)
);
...
CREATE TABLE gracethd3_1_raw.t_cable (
    ...
    cb_tech              VARCHAR(3),
    cb_user              VARCHAR(20),
    CONSTRAINT pk_t_cable PRIMARY KEY (cb_code, cb_codeext)
);
...
CREATE TABLE gracethd3_1_raw.t_zpbo (
    ...
    CONSTRAINT pk_t_zpbo PRIMARY KEY (zp_bp_code, zp_code)
);
